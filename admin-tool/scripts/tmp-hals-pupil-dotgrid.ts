...
async function main() {
  const targets: [string, string, number, number, number, number, number, number][] = [
    ["newbase-sophia-frontal-hals", "pupil-sophia", 460, 220, 260, 100, 20, 2.2],
    ["newbase-claire-frontal-hals", "pupil-claire", 350, 175, 260, 100, 20, 2.2],
    ["newbase-jen-frontal-hals", "pupil-jen", 330, 210, 260, 100, 20, 2.2],
    ["newbase-amara-frontal-hals", "pupil-amara", 340, 235, 260, 100, 20, 2.2],
  ];
