...
async function main() {
  const targets: [string, string, number, number, number, number, number, number][] = [
    ["newbase-claire-dreiviertelprofil-ring", "d4-claire-dvp", 570, 800, 350, 280, 40, 1.5],
    ["newbase-jen-frontal-ring", "d4-jen-frontal", 550, 900, 350, 280, 40, 1.5],
    ["newbase-amara-frontal-ring", "d4-amara-frontal", 500, 900, 350, 280, 40, 1.5],
  ];
