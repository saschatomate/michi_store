...
async function main() {
  const targets: [string, string, number, number, number, number, number, number][] = [
    ["newbase-sophia-frontal-ring", "d3-sophia-frontal", 580, 790, 280, 220, 40, 1.9],
    ["newbase-sophia-dreiviertelprofil-ring", "d3-sophia-dvp", 590, 630, 280, 220, 40, 1.9],
    ["newbase-claire-dreiviertelprofil-ring", "d3-claire-dvp", 570, 845, 280, 220, 40, 1.9],
    ["newbase-jen-frontal-ring", "d3-jen-frontal", 510, 918, 280, 220, 40, 1.9],
    ["newbase-amara-frontal-ring", "d3-amara-frontal", 450, 935, 280, 220, 40, 1.9],
  ];
